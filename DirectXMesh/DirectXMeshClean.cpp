...
namespace
{
    ...
    HRESULT CleanImpl(_Inout_updates_all_(nFaces * 3) index_t* indices,
        size_t                                                 nFaces,
        size_t                                                 nVerts,
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ HRESULT DirectX::Clean(uint16_t* indices,
    size_t                                              nFaces,
    size_t                                              nVerts,
    uint32_t*                                           adjacency,
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ HRESULT DirectX::Clean(uint32_t* indices,
    size_t                                              nFaces,
    size_t                                              nVerts,
    uint32_t*                                           adjacency,
    const uint32_t*                                     attributes,
