...
.DESCRIPTION
This script promotes the views of the DirectXMesh NuGet packages on the project-scoped feed. It always promotes to Prerelease view, and if the Release switch is set, it also promotes to Release view.
